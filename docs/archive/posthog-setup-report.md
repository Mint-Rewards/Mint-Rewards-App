...
> Auto-generated by the PostHog install wizard. **Its event list is largely obsolete** — nine of the events it claims (brand_tapped, campaign_viewed, coupon_downloaded, coupon_download_failed, discount_viewed, profile_updated, referral_sent, forgot_password_requested, account_deleted) no longer exist, and eleven undocumented ones have appeared since. HANDOFF.md §10 lists what is actually instrumented today.
